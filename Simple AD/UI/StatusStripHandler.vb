...
Public Module StatusStripHandler
    ...
    Public Sub UpdateConnectionText(ByVal Text As String)
        ...
        FormMain.Invoke(Sub()
                            FormMain.ConnectionToolStripStatusLabel.Image =
                                New Icon(My.Resources.SystemTask, 16, 16).ToBitmap
                            FormMain.ConnectionToolStripStatusLabel.Text =
                                "  Connected to " & GetDomainNetBiosName()
                        End Sub)
    End Sub
    ...
    Public Sub UpdateContextStripText(ByVal Text As String)
        FormMain.Invoke(Sub()
                            ...
                            FormMain.ToolStripStatusLabelContext.Image =
                                New Icon(My.Resources.Selected, 16, 16).ToBitmap
                        End Sub)
    End Sub
    ...
    Public Sub UpdateQueryTimeText(ByVal Text As String)
        FormMain.Invoke(Sub()
                            ...
                            FormMain.QueryToolStripLabel.Image =
                                New Icon(My.Resources.Timer, 16, 16).ToBitmap

                            If String.IsNullOrEmpty(FormMain.QueryToolStripLabel.ToolTipText) Then
                                FormMain.QueryToolStripLabel.ToolTipText =
                                    "Query Time" & Environment.NewLine & Environment.NewLine &
                                    "Displays the time spent on the last domain query, " &
                                    Environment.NewLine &
                                    "including time taken to parse the results the rebuild the list."
                            End If
        ...
        If Not String.IsNullOrEmpty(Path) Then
            ...
            If Not FormatPath Then
                FormMain.Invoke(Sub()
                                    ...
                                    FormMain.ContainerToolStripStatusLabel.Image =
                                        New Icon(My.Resources.Repository, 16, 16).ToBitmap
                                End Sub)
                Exit Sub
            End If
            ...
            Dim result As String = Mid(Path, nIndexStart + sDelimStart.Length + 1,
