...
#End Region
    ...
    Protected Overrides Sub OnHandleCreated(e As EventArgs)
        NativeMethods.SendMessage(Handle, NativeMethods.TVM_SETEXTENDEDSTYLE, New IntPtr(NativeMethods.TVS_EX_DOUBLEBUFFER), New IntPtr(NativeMethods.TVS_EX_DOUBLEBUFFER))
    ...
    Public Sub InitialLoad()
        Try
            ...
            End Using
            RootNode.Text = GetLocalDomainName()
    ...
    Private Sub InitialLoadFinished(ByVal RootNode As TreeNode, ByVal ErrorMessage As String)
        If InvokeRequired Then
            Invoke(New Action(Of TreeNode, String)(AddressOf InitialLoadFinished), RootNode, ErrorMessage)
        Else
    ...
    Private Sub LoadFinished(ByVal Success As Boolean, ByVal Message As String, ByVal Node As TreeNode, ByVal NewChildren As List(Of TreeNode))
        If InvokeRequired Then
            Invoke(New Action(Of Boolean, String, TreeNode, List(Of TreeNode))(AddressOf LoadFinished), Success, Message, Node, NewChildren)
        Else
            If Not IsDisposed Then
                Try
                    If Success Then
