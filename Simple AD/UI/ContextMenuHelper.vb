...
Public Module ContextMenuHelper
    ...
    Public Sub GetListViewConextMenu(ListView As ListView,
                                     e As EventArgs,
                                     ContextMenuStrip As ContextMenu,
                                     sender As Object, RowObject As DomainObject)
    ...
    Public Sub GetTemplateManConextMenu(ListView As ListView,
                                        e As EventArgs,
                                        ContextMenuStrip As ContextMenu,
                                        sender As Object,
                                        RowObject As DomainObject)
