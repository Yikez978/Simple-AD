...
Public Module FileExportHelper

    Public Sub ExportFile(Source As DataGridView, Dialog As SaveFileDialog)
    ...
    Public Sub ExportFileBW_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs)
    ...
    Public Sub ExportFileBW_RunWorkerCompleted(ByVal sender As Object, ByVal e As RunWorkerCompletedEventArgs)
